...
public class BPerms extends JavaPlugin {
    ...
    public void onEnable() {
        try {
            ...
            mysql = new MySQL(sqlConfig.getString("mysql.host"), sqlConfig.getString("mysql.database"), sqlConfig.getString("mysql.username"), sqlConfig.getString("mysql.password"), sqlConfig.getInt("mysql.port"));
            mysql.connect();
            ...
            this.getCommand("bperms").setExecutor(new CMDBperms());

            this.getServer().getPluginManager().registerEvents(new JoinAndQuitListener(), this);
    ...
    private void initHelpMessage() {
        ...
        TextComponent reload = new TextComponent("§b 1. /bperms reload");
        ...
        TextComponent groups = new TextComponent("§b 2. /bperms groups");
        ...
        TextComponent addgroup = new TextComponent("§b 3. /bperms addgroup [name]");
        ...
        TextComponent removegroup = new TextComponent("§b 4. /bperms removegroup [group]");
        ...
        TextComponent gInfo = new TextComponent("§b 5. /bperms group [group] info");
        ...
        TextComponent Import = new TextComponent("§b 6. /bperms group [group] import [group] <add/replace>");
        ...
        TextComponent Implement = new TextComponent("§b 7. /bperms group [group] addParent [group]");
        ...
        TextComponent UnImplement = new TextComponent("§b 8. /bperms group [group] removeParent [group]");
        ...
        TextComponent PermADD = new TextComponent("§b 9. /bperms group [group] permission add [permission]");
        ...
        TextComponent PermREM = new TextComponent("§b 10. /bperms group [group] permission remove [permission]");
        ...
        TextComponent Default = new TextComponent("§b 11. /bperms group [group] default <true/false>");
        ...
        TextComponent Prefix = new TextComponent("§b 12. /bperms group [group] prefix [prefix]");
        ...
        TextComponent Suffix = new TextComponent("§b 13. /bperms group [group] suffix [suffix]");
        ...
        TextComponent Display = new TextComponent("§b 14. /bperms group [group] display [displayname]");
        ...
        TextComponent Tab = new TextComponent("§b 15. /bperms group [group] tab [tablistname]");
        ...
        TextComponent uInfo = new TextComponent("§b 16. /bperms user [player] info");
        ...
        TextComponent uAdd = new TextComponent("§b 17. /bperms user [player] group add [group]");
        ...
        TextComponent uRem = new TextComponent("§b 18. /bperms user [player] group remove [group]");
        ...
        TextComponent uParent = new TextComponent("§b 19. /bperms user [player] parent set [group]");
        ...
        TextComponent permList = new TextComponent("§b 20. /bperms listPerms");
